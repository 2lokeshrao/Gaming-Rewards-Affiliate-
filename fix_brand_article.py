...
text = re.sub(
    r'<div className="bg-slate-950 text-slate-300 font-sans selection:bg-amber-400 selection:text-slate-950 pt-8 pb-16">\s*<div className="max-w-7xl mx-auto px-4">',
    header,
    text
)
