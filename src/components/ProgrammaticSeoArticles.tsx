                  ...
                  return (
                    <div key={`slide-${platform.id}`} className="w-full flex-shrink-0 p-5 sm:p-8">
                      ...
                      <div className="flex items-center gap-4 mb-6">
                        <img loading="lazy" src={platform.logoUrl} alt={`${platform.name} logo`} className="w-12 h-12 rounded-full border-2 border-slate-800 bg-slate-950 object-cover shadow-lg" />
                        <div>
