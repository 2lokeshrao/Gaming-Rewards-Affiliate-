    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-2 border-b border-slate-800">
        {localPlatforms.map(p => (
          ...
          >
            <img width="40" height="40" decoding="async" onError={(e) => { e.currentTarget.src = "/logos/placeholder.png"; }} loading="lazy" src={p.logoUrl} alt={p.name} className="w-5 h-5 rounded object-cover" />
            <span>{p.name}</span>
            {p.metaTitle ? (
          ...
          <div className="lg:col-span-7 bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-5 shadow-xl">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
              <div className="flex items-center gap-2">
                <img width="40" height="40" decoding="async" loading="lazy" onError={(e) => { e.currentTarget.src = "/logos/placeholder.png"; }}  src={selectedPlatform.logoUrl} alt="" className="w-8 h-8 rounded-lg object-cover" />
                <div>
