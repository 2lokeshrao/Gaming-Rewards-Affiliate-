          ...
          <div className="space-y-4">
            {otherPlatforms.map(p => {
              ...
              return (
                ...
                >
                  <img width="40" height="40" decoding="async" onError={(e) => { e.currentTarget.src = "/logos/placeholder.png"; }} loading="lazy" src={p.logoUrl} alt={p.name} className="w-10 h-10 rounded-full border-2 border-slate-700 object-cover" />
