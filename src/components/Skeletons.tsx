...
export const CarouselSkeleton: React.FC = () => {
  return (
    <div className="w-full max-w-7xl mx-auto px-4 mt-8">
      <div className="h-8 w-64 bg-slate-800 rounded-lg animate-pulse mb-6" />
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[1, 2, 3].map((i) => (
          <div key={i} className="bg-slate-900 border border-slate-800 rounded-3xl p-6 h-[400px] flex flex-col items-center animate-pulse">
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 mt-16 mb-24">
      <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        ...
        <div className="h-10 w-full md:w-64 bg-slate-800 rounded-xl animate-pulse" />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="bg-slate-900 border border-slate-800 rounded-3xl p-6 h-[300px] flex flex-col animate-pulse">
...
export const AppSkeleton: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-950">
      {/* Navbar Skeleton */}
      <div className="h-20 bg-slate-900 border-b border-slate-800 w-full animate-pulse flex items-center justify-between px-6">
        <div className="w-40 h-8 bg-slate-800 rounded-lg" />
        <div className="w-24 h-8 bg-slate-800 rounded-lg hidden md:block" />
      </div>
      {/* Hero Skeleton */}
      <div className="w-full h-64 bg-slate-900/50 flex flex-col items-center justify-center p-6 animate-pulse">
